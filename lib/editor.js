...
;(function(run) {
  ...
  function computeIndentOffset(src, parentSexp, idx) {
    ...
    if (isSomeSpecialForm(exports.specialForms1, parentSexp, src)) {
    ...
    if (isSomeSpecialForm(exports.specialForms2, parentSexp, src)) {
        var iChild = computeChildIndex(parentSexp.children, idx);
    ...
    if (isSomeSpecialForm(exports.specialForms3, parentSexp, src)) {
        var iChild = computeChildIndex(parentSexp.children, idx);
        if( iChild == 1 || iChild == 2 || iChild == 3 ) {
                return rowColumnOfIndex(src, parentSexp.start + parentSexp.open.length+3);
        } else {
                return rowColumnOfIndex(src, parentSexp.start + parentSexp.open.length+1);
        }
